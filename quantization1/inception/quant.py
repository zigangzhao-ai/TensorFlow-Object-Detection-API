...
# graph_def_file = "ssd_mobilenet_v1_coco_2017_11_17.pb"
graph_def_file = "frozen_inference_graph_resnet.pb"

# input_names = ["Preprocessor/sub"]
# input_names = ["FeatureExtractor/MobilenetV1/MobilenetV1/Conv2d_0/BatchNorm/batchnorm/mul_1"]
input_names = ["Preprocessor/sub"]
# print("=========================")
# print(input_names)
# print(input_names[0])
...
input_tensor = {input_names[0]:[1,640,640,3]}
